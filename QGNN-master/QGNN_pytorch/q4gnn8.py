...
kernel_list=[[1, -2, -3, -4, -5, -6, -7, -8], [2, 1, -4, 3, -6, 5, 8, -7], [3, 4, 1, -2, -7, -8, 5, 6], [4, -3, 2, 1, -8, 7, -6, 5], [5, 6, 7, 8, 1, -2, -3, -4], [6, -5, 8, -7, 2, 1, 4, -3], [7, -8, -5, 6, 3, -4, 1, 2], [8, 7, -6, -5, 4, 3, -2, 1]]
...
def make_quaternion_mul(weight_list):
    ...
    dim=weight_list.size(1)//8
    dim_list=[gg for gg in torch.split(weight_list,[dim]*8,dim=1)]
    cat_kernels_list = []
    for i in range(8):
        tempt = []
        for j in range(8):
