...
class QGNN(torch.nn.Module):
    def __init__(self, nfeat, nhid, nclass, dropout=0.5):
        ...
        self.q4gnn2 = QGNNLayer(nhid//4, nhid//4, dropout=dropout)
        self.q4gnn3 = QGNNLayer(nhid//4, nhid//4, dropout=dropout)
        self.q4gnn4 = QGNNLayer(nhid//4, nhid//4, dropout=dropout)
        self.q4gnn5 = QGNNLayer(nhid//4, nhid//4, dropout=dropout)
    ...
    def forward(self, x, adj,mask):
        ...
        y1=self.q4gnn2(x1,adj)
        y12=self.menk1(y1,adj)
        x2=y12*x2
        y2=self.q4gnn3(x2,adj)
        y22=self.menk1(y2,adj)
        x3=y22*x3
        y3 = self.q4gnn4(x3, adj)
        y32=self.menk1(y3,adj)
        x4=y32*x4
        y4 = self.q4gnn5(x4, adj)
