...
class AFDCal:
    ...
    from ._plot_ori import plot_dict, plot_base, plot_decomp, plot_basis_comp, plot_re_sig, plot_energy_rate, plot_searchRes, plot_base_random, plot_remainder, plot_an, plot_ori_sig
